...
public class BigBulbFlowerFoliagePlacer extends FoliagePlacer {
    public static final Codec<BigBulbFlowerFoliagePlacer> CODEC = RecordCodecBuilder.create(bigBulbFlowerFoliagePlacerInstance ->
            fillFoliagePlacerFields(bigBulbFlowerFoliagePlacerInstance).and(Codec.intRange(0, 12).fieldOf("height")
                    .forGetter(instance -> instance.height)).apply(bigBulbFlowerFoliagePlacerInstance, BigBulbFlowerFoliagePlacer::new));
    private final int height;

    public BigBulbFlowerFoliagePlacer(IntProvider radius, IntProvider offset, int height) {
        super(radius, offset);
        this.height = height;
    }
    ...
    protected FoliagePlacerType<?> getType() {
        return ModFoliagePlacerTypes.BIG_BULB_FLOWER_FOLIAGE_PLACER;
    }
